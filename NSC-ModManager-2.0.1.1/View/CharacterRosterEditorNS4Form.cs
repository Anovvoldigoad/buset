...
namespace NSC_ModManager.View
{
    ...
    /// CharacterRosterEditorNS4ViewModel, same slot-reordering logic (ReplaceSlots,
    ...
    /// </summary>
    public partial class CharacterRosterEditorNS4Form : Form
    {
        private readonly CharacterRosterEditorNS4ViewModel VM;
        ...
        public CharacterRosterEditorNS4Form(TitleViewModel titleVM)
        {
            VM = new CharacterRosterEditorNS4ViewModel(titleVM);
