...
namespace NSC_ModManager.ViewModel
{
    ...
    public class NUS3BANKViewModel : INotifyPropertyChanged
    {
        ...
        public void OpenFile(string basepath = "")
        {
            ...
            if (File.Exists(FilePath))
            {
                ...
                if (Format == "NUS3")
                {
                    ...
                    System.Windows.MessageBox.Show((string)System.Windows.Application.Current.Resources["m_nus3bankEditor_error_1"]);
            }
        ...
        public void PlaySound()
        {
            ...
            {
                System.Windows.MessageBox.Show((string)System.Windows.Application.Current.Resources["m_nus3bankEditor_warning"]);
                return;
        ...
        public void SaveFileAs(string basepath = "")
        {
            ...
            {
                System.Windows.MessageBox.Show((string)System.Windows.Application.Current.Resources["m_error_72"]);
            }
        }
